...
public class BaseDao1 {
    ...
    //需要生成mapper文件的sql语句
    private static String sql = "select mc.MEDICINE_NAME,dmm.code_id,dmm.amt from\n" +
            "\t\tmedicine_code mc join doctor_menu_medicine dmm on mc.code_id=dmm.code_id";
    //主表
    private static String mainTable = "doctor_menu_medicine";
